...
/* setContentView'i üstteki kodlardan sonra tanımlayın
  yoksa program kırılacaktır. */
        ...
        this.getSupportActionBar().setSubtitle("Araçları Eşleştir");
        Intent i = getIntent();
        ...
        final kartAraclar kartlar[] = new kartAraclar[20];
        ...
        for (int j = 1; j <= 20; j++) {
            kartlar[j - 1] = new kartAraclar(this, j);
            ...
            kartlar[j - 1].setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    final kartAraclar k = (kartAraclar) view;
                    k.cevir();
                    if (sonKart > 0) {
                        final kartAraclar k2 = (kartAraclar) findViewById(sonKart);
                        if (k2.onPlanID == k.onPlanID && k2.getId() != k.getId()) {
                            ...
                            if (skor == 10) {
                                ...
                                Intent i = new Intent(Activity_Vehicles.this, Activity_Main.class);
        ...
        //Kartları Karıştır
        for (int j = 0; j < 20; j++) {
            int rg = (int) (Math.random() * 20);
            kartAraclar k = kartlar[rg];
